...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s flocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  flocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded flocoin transaction") + "\n" +
              "  flocoin-tx [options] -create [commands]   " + _("Create hex-encoded flocoin transaction") + "\n" +
              "\n";
