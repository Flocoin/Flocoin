...
const char * const BITCOIN_CONF_FILENAME = "flocoin.conf";
const char * const BITCOIN_PID_FILENAME = "flocoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Flocoin";
#else
    // Unix
